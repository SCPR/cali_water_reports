...
from monthly_water_reports.views import InitialIndex, ComparisonIndex, EnforcementIndex, RegionDetailView, RegionEmbedView, SupplierDetailView

urlpatterns = patterns("monthly_water_reports.views",
